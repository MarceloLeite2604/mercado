...
public class OldTemporalTicker {
	...
	public OldTemporalTicker(Currency currency, ZonedDateTime start, ZonedDateTime end, Long orders, Long buyOrders,
	...
	public OldTemporalTicker(TemporalTicker temporalTicker) {
