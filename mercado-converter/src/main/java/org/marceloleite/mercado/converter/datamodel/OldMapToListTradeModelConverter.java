...
import org.marceloleite.mercado.converter.json.old.OldTradeConverter;
...
public class OldMapToListTradeModelConverter implements Converter<Map<Long, JsonTrade>, List<TradePO>> {
