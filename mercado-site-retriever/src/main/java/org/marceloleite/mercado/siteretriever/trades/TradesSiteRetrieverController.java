...
public class TradesSiteRetrieverController {
	...
	public Map<Integer, JsonTrade> retrieve(Currency currency, LocalDateTime initialTime, Duration duration) {
		...
		for (int step = 0; step < totalSteps; step++) {
			Callable<Map<Integer, JsonTrade>> tradesRetrieverCallable = new TradesSiteRetrieverCallable(currency, from,
					to);
