...
@JsonPropertyOrder({ "order_id", "coin_pair", "order_type", "status", "has_fills", "quantity", "limit_price",
		"executed_quantity", "executed_price_avg", "fee", "created_timestamp", "updated_timestamp", "operations" })
