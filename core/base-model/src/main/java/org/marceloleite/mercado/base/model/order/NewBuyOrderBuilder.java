...
public class NewBuyOrderBuilder {

	@SuppressWarnings("unused")
	private static final Logger LOGGER = LogManager.getLogger(NewBuyOrderBuilder.class);
	...
	public NewBuyOrderBuilder() {
		this.firstCurrency = Currency.REAL;
	}

	public NewBuyOrderBuilder buyingCurrency(Currency currencyToBuy) {
		this.secondCurrency = currencyToBuy;
		return this;
	}

	public NewBuyOrderBuilder buying(CurrencyAmount currencyAmountToBuy) {
		this.secondCurrency = currencyAmountToBuy.getCurrency();
		this.quantity = currencyAmountToBuy.getAmount();
		return this;
	}

	public NewBuyOrderBuilder payingUnitPriceOf(CurrencyAmount currencyAmountPayingUnitPrice) {
		this.firstCurrency = currencyAmountPayingUnitPrice.getCurrency();
		this.limitPrice = currencyAmountPayingUnitPrice.getAmount();
		return this;
	}

	public NewBuyOrderBuilder toExecuteOn(ZonedDateTime time) {
		this.time = time;
		return this;
	}
