...
public class Main {
	...
	private static void alarm() {
		ZonedDateTime start = ZonedDateTime.of(LocalDateTime.of(2018, 01, 01, 07, 00), ZonedDateTimeUtils.DEFAULT_ZONE_ID);
		ZonedDateTime end = ZonedDateTime.of(LocalDateTime.of(2018, 01, 02, 07, 00), ZonedDateTimeUtils.DEFAULT_ZONE_ID);
		Duration divisionDuration = Duration.ofMinutes(1);
		ZonedDateTime alarmTime = ZonedDateTime.of(LocalDateTime.of(2018, 01, 01, 10, 17), ZonedDateTimeUtils.DEFAULT_ZONE_ID);
		ZonedDateTime disarmTime = ZonedDateTime.of(LocalDateTime.of(2018, 01, 01, 10, 20), ZonedDateTimeUtils.DEFAULT_ZONE_ID);
		...
		for (TimeInterval timeInterval : timeIntervals) {
			if (disarmTime.isEqual(timeInterval.getStart())) {
				...
				alarm.disarm();
				alarmTime = ZonedDateTime.of(LocalDateTime.of(2018, 01, 01, 16, 00), ZonedDateTimeUtils.DEFAULT_ZONE_ID);
			...
			System.out.println(zonedDateTimeToStringConverter.convertTo(timeInterval.getStart()) + ": " + status + ".");
		}
	}	
}
