...
@Embeddable
public class OldClassParameterIdPO implements Serializable {

	private static final long serialVersionUID = 1L;

	@Column(name = "STCL_STRA_ACCO_OWNER", insertable=false, updatable=false)
	private String accountOwner;

	@Column(name = "STCL_STRA_CURRENCY", insertable=false, updatable=false)
	private Currency strategyCurrency;
	
	@Column(name = "STCL_CLASS_NAME", nullable = false)
