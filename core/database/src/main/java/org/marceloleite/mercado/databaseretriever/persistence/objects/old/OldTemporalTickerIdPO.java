...
@Embeddable
public class OldTemporalTickerIdPO implements Serializable {
	...
	public OldTemporalTickerIdPO() {
		super();
	}

	public OldTemporalTickerIdPO(Currency currency, ZonedDateTime start, ZonedDateTime end) {
		super();
